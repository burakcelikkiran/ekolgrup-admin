...
<head>
    <title>Ekol Grup - Başvuru Formu</title>
...
<div class="page-wrapper">
    ...
    <section class="page-header clearfix" style="background-image: url(assets/images/backgrounds/page-header-bg.jpg);">
        <div class="container">
            <div class="page-header__inner clearfix">
                <h2 class="wow slideInDown animated" data-wow-delay="0.3s" data-wow-duration="1500ms">İnsan
                    Kaynakları</h2>
            </div>
        </div>
    </section>
                        ...
                        <div class="services-details__text-box1"
                            ...
                            <form action="https://alfredform.ko.com.tr/handle/gcM69GFOMyLfXA6oU0eyzDgSQt32dX7Wyao33Ozz" method="POST">
                                ...
                                <div class="form-elem">
                                    ...
                                    <a href="is-basvurusu-kvkk.php" target="_blank" title="KVKK">Çalışan Adayları Aydınlatma Metnini </a>
    ...
    <style>
        ...
        .checkbox label input{ width: 40px; }
