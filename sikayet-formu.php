...
<head>
    <title>Ekol Grup - Şikayet Formu</title>
    ...
    <section class="page-header clearfix" style="background-image: url(assets/images/backgrounds/page-header-bg.jpg);">
        <div class="container">
            <div class="page-header__inner clearfix">
                <h2 class="wow slideInDown animated" data-wow-delay="0.3s" data-wow-duration="1500ms">Şikayet ve Bilgilendirme Formu</h2>
            </div>
        </div>
    </section>
    <div class="container">
                            ...
                            <h2 class="text-center">Şikayet ve Bilgilendirme Formu</h2>
                                ...
                                <form action="https://alfredform.ko.com.tr/handle/F8RAsLRz3R3leGa1xrrzZS7Ew1Z21xxLW91ic6LX" method="POST">
                                    ...
                                    <div class="form-elem mt-3">
                                        ...
                                        <a href="kvkk.php" target="_blank" title="KVKK">KVKK Aydınlatma Metnini </a>okuduğunuzu ve kabul ettiğinizi onaylıyorsunuz.<br><br>
