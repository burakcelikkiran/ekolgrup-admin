...
<body>
    ...
    <div class="page-wrapper">
        ...
        <iframe src="https://www.google.com/maps/d/embed?mid=1dMIszsfdEIVQ6cUU3gLoZulQIdmanyXo" style="width: 100%;border: 0;height: 400px;"></iframe>
                                    ...
                                    <div class="col-xl-5 col-lg-5 wow fadeInUp p-0" data-wow-delay="0.1s" data-wow-duration="1500ms">
                                        <div class="contact-box__single text-center">
                                            ...
                                            <div class="contact-box__single-text">
                                                ...
                                                <p style="padding: 0;margin: 0 20px;">Armağanevler Mah . Mithatpaşa Cad.  No:138 Kat:2,<br>Ümraniye - İstanbul</p>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-5 col-lg-4 wow fadeInUp p-0" data-wow-delay="0.1s" data-wow-duration="1500ms">
                                        <div class="contact-box__single text-center">
                                            ...
                                            <div class="contact-box__single-text">
                                                <h2><a href="#">Adres</a></h2>
                                                <p>Şirinevler Mah. Tevfik Fikret Cad.<br>Taç İş Merkezi No: 2 Kat: 6<br>Bahçelievler / İSTANBUL</p>
                                            </div>
                                        </div>
        ...
        <script>
            function initMap() {
                ...
                const tourStops = [
                    ...
                    [{ lat: 40.99412, lng: 28.84994 }, "MNE GÜVENLİK OKULLARI","0212 275 94 95","Şirinevler Mah. Tevfik Fikret Cad.Taç İş Merkezi No: 2 Kat: 6Bahçelievler / İSTANBUL"],
                    ...
                    [{ lat: 38.67359, lng: 39.22262 }, "ELAZIĞ DOĞU-GÜNEYDOĞU BLG.MD.","0 424 236 61 66","Çarşı Mh Antik Sk No: 2/1 Merkez/ELAZIĞ"],
                ];
                ...
                tourStops.forEach(([position, title,tel,adres], i) => {
                    const marker = new google.maps.Marker({
                        ...
                        map,
                        title: `${i + 1}. ${title}`,
                        content:"<h3>"+title+"</h3> <a target='_blank' href='https://maps.google.com/?q="+position['lat']+","+position['lng']+"'>Haritada Aç</a> ",
                        optimized: false,
                    });
            ...
            function mapDetail(title,position,tel,adres) {
                ...
                document.getElementById("konum").innerHTML ="<a target='_blank' href='https://maps.google.com/?q="+position['lat']+","+position['lng']+"'>Haritada Aç</a>";
                ...
                document.getElementById("adres").innerHTML ="<span class='icon-pin mapstyle'></span>"+adres;
            }
        </script>
        <style>
            #map {
