<x-app-layout>
    ...
    <section class="page-header clearfix" style="background-image: url(/assets/images/backgrounds/page-header-bg.jpg);">
                            ...
                            <div class="services-details__text-box1">
                                ...
                                <form action="https://alfredform.ko.com.tr/handle/hb9mNUId9Tz3vo0ccTVWEw6pRmOImbMeuTEyfiYF" method="POST">
                                    ...
                                    <div class="form-elem text-center">
                                        ...
                                        <a href="/insan-kaynaklari/kvkk" target="_blank" title="KVKK">KVKK Aydınlatma Metnini </a>okuduğunuzu
        ...
        @section('title') {{ 'Eğitim Talep Formu'}} @endsection

        @section('seo_title') {{ 'Eğitim Talep Formu'}} @endsection

        @section('seo_description') {{nova_get_setting('description')}} Eğitim Talep Formu @endsection

        @section('seo_keywords') {{nova_get_setting('keywords')}} Eğitim Talep Formu @endsection
</x-app-layout>
