...
class Kalite extends Resource
{
    public static function label() {
        return 'Kalite Belgelerimiz';}
     ...
     * @var string
     */
    public static $model = \App\Models\Kalite::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Kısa Menü Adı','menu_name')->hideFromIndex()->rules('max:50')
